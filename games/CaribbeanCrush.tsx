    ...
    <div className="fixed inset-0 flex flex-col items-center bg-gradient-to-b from-[#00BFFF] to-[#87CEEB] overflow-hidden select-none">
      ...
      <AnimatePresence>
        {completedPlayers.length > 0 && !showTurnPopup && (
          ...
          >
            <div className="flex items-center gap-2 mb-2 bg-white/40 px-3 py-1 rounded-full w-fit border border-white/30">
      ...
      <div className="w-full bg-[#3C3C3C]/98 border-t border-white/10 p-10 z-[700] flex flex-col items-center gap-8 shadow-[0_-20px_100px_rgba(0,0,0,0.3)] relative">
